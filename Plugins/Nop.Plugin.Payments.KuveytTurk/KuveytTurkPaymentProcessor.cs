...
using Nop.Plugin.Payments.KuveytTurk.Controllers;
...
namespace Nop.Plugin.Payments.KuveytTurk
{
    ...
    public class KuveytTurkPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        protected ProcessPaymentResult AuthorizeOrSale(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            var hostAddress = _KuveytTurkPaymentSettings.UseTestServer ? _KuveytTurkPaymentSettings.TestServiceUrl : _KuveytTurkPaymentSettings.ServiceUrl;
            ccpayment.host = hostAddress;// "https://netpos.kuveytturk.com.tr/servlet/cc5ApiServer";//"https://testsanalpos.est.com.tr/servlet/cc5ApiServer";//
            ccpayment.name = _KuveytTurkPaymentSettings.UseTestServer?_KuveytTurkPaymentSettings.TestName :_KuveytTurkPaymentSettings.Name;// "sanalpos"; //"KUVEYTAPI";//
            ccpayment.password = _KuveytTurkPaymentSettings.UseTestServer?_KuveytTurkPaymentSettings.TestPassword:_KuveytTurkPaymentSettings.Password;// "V7Z4M3SgmiJ";//"KUVEYT123";//
            ccpayment.clientid = _KuveytTurkPaymentSettings.UseTestServer ? _KuveytTurkPaymentSettings.TestClientId : _KuveytTurkPaymentSettings.ClientId;//"110000810";//"110000000";//
            ccpayment.chargetype = "Auth";
            ccpayment.orderresult =_KuveytTurkPaymentSettings.TestOrder ? 1 : 0;
            ...
            else
            {
                ...
                else
                {
                    ...
                    loger.Error("Payments.CC.KuveytTurk: errorcode:" + ccpayment.code + "\n\r errortext:" + ccpayment.errmsg);
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "PaymentKuveytTurk";
            routeValues = new RouteValueDictionary() { { "Namespaces", "Nop.Plugin.Payments.KuveytTurk.Controllers" }, { "area", null } };
        }
        ...
        {
            return typeof(PaymentKuveytTurkController);
        }

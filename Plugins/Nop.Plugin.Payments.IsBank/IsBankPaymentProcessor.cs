...
using Nop.Plugin.Payments.IsBank.Controllers;
...
{
    /// <summary>
    /// IsBank payment processor
    /// </summary>
    public class IsBankPaymentProcessor : BasePlugin, IPaymentMethod
    {
        #region Fields
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "PaymentIsBank";
            routeValues = new RouteValueDictionary() { { "Namespaces", "Nop.Plugin.Payments.IsBank.Controllers" }, { "area", null } };
        }
        ...
        {
            return typeof(PaymentIsBankController);
        }

...
using Nop.Plugin.DiscountRules.HasSomeProducts.Models;
using Nop.Services.Customers;
using Nop.Services.Discounts;
using Nop.Web.Framework.Controllers;

namespace Nop.Plugin.DiscountRules.HasSomeProducts.Controllers
{
    [AdminAuthorize]
    public class DiscountRulesHasSomeProductsController : Controller
    {
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId, string variantIds)
        {
            ...
            else
            {
                ...
                {
                    DiscountRequirementRuleSystemName = "DiscountRequirement.HasSomeProducts",

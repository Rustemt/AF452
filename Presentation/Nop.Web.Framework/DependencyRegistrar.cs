...
namespace Nop.Web.Framework
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            builder.RegisterType<ExtraContentService>().As<IExtraContentService>().InstancePerHttpRequest();
            ...
            builder.RegisterType<NebimIntegrationService>().As<INebimIntegrationService>().InstancePerHttpRequest();
            builder.RegisterType<NebimIntegrationImportService>().As<INebimIntegrationImportService>().InstancePerHttpRequest();

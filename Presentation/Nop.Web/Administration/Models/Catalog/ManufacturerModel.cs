...
namespace Nop.Admin.Models.Catalog
{
    ...
    public class ManufacturerModel : BaseNopEntityModel, ILocalizedModel<ManufacturerLocalizedModel>
    {
		...
		[UIHint("Picture")]
		[NopResourceDisplayName("Admin.Catalog.Manufacturers.Fields.MenuPicture")]
		public int MenuPictureId { get; set; }

		[UIHint("Picture")]
		[NopResourceDisplayName("Admin.Catalog.Manufacturers.Fields.MenuShowcasePicture")]
		public int MenuShowcasePictureId { get; set; }
        ...
        public class ManufacturerNewsItemModel : BaseNopEntityModel
        {
            public int ManufacturerId { get; set; }

            public int NewsItemId { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Manufacturers.Products.Fields.NewsItem")]
        ...
        public class AddManufacturerNewsItemModel : BaseNopModel
        {
            public AddManufacturerNewsItemModel()
            {
                AvailableCategories = new List<SelectListItem>();
                AvailableManufacturers = new List<SelectListItem>();
            }
            ...
            [NopResourceDisplayName("Admin.Catalog.Products.List.SearcNewsItemName")]
            [AllowHtml]
            public string SearchProductName { get; set; }
            [NopResourceDisplayName("Admin.Catalog.Products.List.SearchCategory")]
            public int SearchCategoryId { get; set; }
            ...
            public int[] SelectedNewsItemIds { get; set; }
        }
        #endregion
    }

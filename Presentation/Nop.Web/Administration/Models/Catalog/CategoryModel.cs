...
namespace Nop.Admin.Models.Catalog
{
    ...
    public class CategoryModel : BaseNopEntityModel, ILocalizedModel<CategoryLocalizedModel>
    {
        ...
        public class CategoryNewsItemModel : BaseNopEntityModel
        {
            public int CategoryId { get; set; }

            public int NewsItemId { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Categories.Products.Fields.NewsItem")]
        ...
        public class AddCategoryNewsItemModel : BaseNopModel
        {
            ...
            [NopResourceDisplayName("Admin.Catalog.Products.List.SearchNewsItemName")]
            [AllowHtml]
            public string SearchProductName { get; set; }
            [NopResourceDisplayName("Admin.Catalog.Products.List.SearchCategory")]
            public int SearchCategoryId { get; set; }

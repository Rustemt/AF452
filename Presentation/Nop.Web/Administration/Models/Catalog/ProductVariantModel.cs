...
namespace Nop.Admin.Models.Catalog
{
    ...
    public class ProductVariantModel : BaseNopEntityModel, ILocalizedModel<ProductVariantLocalizedModel>
    {
        public ProductVariantModel()
        {
            ...
            ProductVariantPictureModels = new List<ProductVariantPictureModel>();
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Variants.Fields.HideDiscount")]
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Variants.Fields.MessageTemplate")]
        public int MessageTemplateId { get; set; }
        public IList<SelectListItem> MessageTemplates { get; set; }
        //AF
        public int CurrencyId { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Variants.Fields.DisplayPriceIfCallforPrice")]
        ...
        public class ProductVariantAttributeValueModel : BaseNopEntityModel, ILocalizedModel<ProductVariantAttributeValueLocalizedModel>
        {
            public ProductVariantAttributeValueModel()
            {
                ...
                ProductAttributeOptionModels = new List<ProductAttributeOptionModel>();
            }
            ...
            public IList<ProductAttributeOptionModel> ProductAttributeOptionModels { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.Variants.ProductVariantAttributes.Attributes.Values.OptionId")]
        ...
        public class ProductVariantAttributeCombinationModel : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Admin.Catalog.Products.Variants.ProductVariantAttributes.AttributeCombinations.Fields.ProductVariantBarcode")]
            public string ProductVariantBarcode { get; set; }
        }
        //AF
        public class ProductVariantPictureModel : BaseNopEntityModel
        {
            public int ProductVariantId { get; set; }
        ...
        public ProductVariantPictureModel AddPictureModel { get; set; }
        public IList<ProductVariantPictureModel> ProductVariantPictureModels { get; set; }

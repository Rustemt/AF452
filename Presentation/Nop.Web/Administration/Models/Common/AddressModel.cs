...
namespace Nop.Admin.Models.Common
{
    ...
    public class AddressModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.Address.Fields.CivilizationNumber")]
        [AllowHtml]
        public string CivilNo { get; set; }

        [NopResourceDisplayName("Admin.Address.Fields.TaxOffice")]
        [AllowHtml]
        public string TaxOffice { get; set; }
        [NopResourceDisplayName("Admin.Address.Fields.TaxNo")]
        [AllowHtml]

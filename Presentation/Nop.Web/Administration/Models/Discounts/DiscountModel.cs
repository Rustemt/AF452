...
namespace Nop.Admin.Models.Discounts
{
    ...
    public class DiscountModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.ShowInCatalog")]
        ...
        // Category, Manufacturer, productVariant Id for the discount
        public string RelatedItemIds { get; set; }

        public bool ExludeRelatedItems { get; set; }

...
namespace Nop.Admin.Models.Settings
{
    ...
    {
        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductDetailDropDownValue")]
        public int ProductDetailDropDownValue { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.RandomCrossSellProductCount")]
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.RecentlyAddedTotalProducts")]
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductlistBannerStartpoint")]
        public string ProductlistBannerStartpoint { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.RecentlyAddedProductsAllowFiltering")]

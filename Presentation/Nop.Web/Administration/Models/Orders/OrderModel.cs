...
namespace Nop.Admin.Models.Orders
{
    public class OrderModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.Orders.Fields.PaymentCampaignNotes")]
        public string PaymentCampaignNotes { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.Installment")]
        ...
        //discount usage history
         [NopResourceDisplayName("Admin.Orders.Fields.Discounts")]

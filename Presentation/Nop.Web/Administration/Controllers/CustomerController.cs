...
namespace Nop.Admin.Controllers
{
    ...
    public class CustomerController : BaseNopController
    {
        ...
        public CustomerController(ICustomerService customerService,
            ...
            IForumService forumService, IOpenAuthenticationService openAuthenticationService, IProductService productService, ICurrencyService currencyService)
        {
        ...
        public ActionResult AddressCreate(CustomerAddressModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (string.IsNullOrWhiteSpace(model.Address.Email))
                {

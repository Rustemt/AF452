...
namespace Nop.Admin.Infrastructure
{
    public class AutoMapperStartupTask : IStartupTask
    {
        public void Execute()
        {
            ...
            Mapper.CreateMap<CustomerProductVariantQuote, ProductVariantQuoteModel>()
                .ForMember(dest => dest.ProductVariantPrice, mo => mo.Ignore());
            Mapper.CreateMap<ProductVariantQuoteModel, CustomerProductVariantQuote>();
            //extracontent
            Mapper.CreateMap<ExtraContent, ExtraContentModel>();
            Mapper.CreateMap<ExtraContentModel, ExtraContent>();
            //address

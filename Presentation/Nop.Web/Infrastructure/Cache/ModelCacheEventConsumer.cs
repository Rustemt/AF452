...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityDeleted<NewsItem>>
    {
        ...
        /// <summary>
        /// Key for ProductBreadcrumbModel Navigation caching
        /// </summary>
        /// <remarks>
        /// {0} : category id
        /// {1} : language id
        /// </remarks>
        public const string PRODUCT_NAVIGATION_MODEL_KEY = "nop.pres.product.navigation-{0}-{1}";
        public const string PRODUCT_NAVIGATION_PATTERN_KEY = "nop.pres.product.navigation";
        ...
        /// {4} : is connection SSL secured?
        /// </remarks>
        public const string PRODUCTVARIANT_DEFAULTPICTURE_MODEL_KEY = "nop.pres.productvariant.picture-{0}-{1}-{2}-{3}-{4}";
        public const string PRODUCTVARIANT_DEFAULTPICTURE_PATTERN_KEY = "nop.pres.productvariant.picture";
        ...
        /// <summary>
        /// Key for products specification filter caching
        /// </summary>
        /// <remarks>
        /// {0} : category id
        /// {1} : language id
        /// </remarks>
        public const string PRODUCTS_SPECFILTER_MODEL_KEY = "nop.pres.productspecfilter.category-{0}-{1}";
        public const string SPECFILTER_MODEL_PATTERN_KEY = "nop.pres.productspecfilter.";

        /// <summary>
        /// Key for products filter caching
        /// </summary>
        /// <remarks>
        /// {0} : category id
        /// {1} : language id
        /// </remarks>
        public const string PRODUCTS_ATTRFILTER_MODEL_KEY = "nop.pres.productattrfilter.category-{0}-{1}";
        public const string ATTRFILTER_MODEL_PATTERN_KEY = "nop.pres.productattrfilter.";

        //AF

        // _Header() tum kategoriler
        public const string CATEGORIES_KEY = "af.categories.lgg-{0}";

        public const string CATEGORY_PICTURES_KEY = "af.category.pictures-{0}";

        public const string CATEGORY_MANUFACTURES_KEY = "af.category.manufactures.category-{0}";
        public const string CATEGORY_MANUFACTURES_PATTERN_KEY = "af.category.manufactures.";
        
        public const string HOMEPAGE_MANUFACTURES_BANNER_KEY = "af.homepage.manufactures.banners-{0}";


        public const string NEWS_MODEL_BY_TYPE_NEWS = "af.home.NewsItem.lgg-{0}.NewsType-{1}.Top-{2}";
        public const string NEWS_MODEL_BY_TYPE_HOMEBOTTOMCONTENT = "af.home.HomeBottomContent.lgg-{0}";
        public const string NEWS_MODEL_BY_TYPE_HOMESLIDER = "af.home.HomeSlider.lgg-{0}";
        public const string NEWS_MODEL_BY_TYPE_HOMEMANUFACTURER = "af.home.HomeManufacturers.lgg-{0}";
        public const string NEWS_MODEL_BY_TYPE_HOMECONTENTBANNER = "af.home.HomeContentBanner.lgg-{0}";
        public const string AF_HOME_PATTERN_KEY = "af.home.";

        public const string AF_NEWS_PAGE = "af.News.Page.ListModel.lgg-{0}.date-{1}.pageNum-{2}.pageSize-{3}";

        public const string AF_MANUFACTURERS_PAGE = "af.Manufacturers.Page.ListModel.lgg-{0}";
        public const string AF_MANUFACTURERS_PAGE_MANPICTURES = "af.Manufacturers.Page.Pictures";

        public const string HOME_PAGE_PRODUCTS = "Nop.HomepageProducts.lgg-{0}.cur-{1}";
        public const string HOME_PAGE_PRODUCTS_PATTERN_KEY = "Nop.HomepageProducts.";
        //AF
        ...
        public void HandleEvent(EntityInserted<Language> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(PRODUCT_NAVIGATION_PATTERN_KEY);
        }
        ...
        {
            _cacheManager.RemoveByPattern(PRODUCT_SPECS_PATTERN_KEY);
            _cacheManager.RemoveByPattern(SPECFILTER_MODEL_PATTERN_KEY);
            _cacheManager.RemoveByPattern(ATTRFILTER_MODEL_PATTERN_KEY);

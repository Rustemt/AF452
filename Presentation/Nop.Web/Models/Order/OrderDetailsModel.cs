...
namespace Nop.Web.Models.Order
{
    public class OrderDetailsModel : BaseNopEntityModel
    {
        ...
        public string OrderReturnRequestMessage { get; set; }
        ...
        public class OrderProductVariantModel : BaseNopEntityModel
        {
            ...
            public OrderProductVariantReturnRequest ItemsReturnRequest { get; set; }

            public class OrderProductVariantReturnRequest : BaseNopEntityModel
            {

...
namespace Nop.Web.Models.Catalog
{
    public class CatalogPagingFilteringModel : BasePageableModel
    {
        ...
        public CatalogPagingFilteringModel()
        {
            ...
            this.OrderBy = (int)ProductSortingEnumAF.Position;
        }
    ...
    //AF
    public class CatalogExtendedPagingFilteringModel : CatalogPagingFilteringModel
    {
        ...
        public AttributeFilterModel ProductAttributeFilter { get; set; }
        
        public PriceRangeSliderModel PriceRangeSliderFilter { get; set; }

        public ProductOuterSortingEnumAF OuterSorting { get; set; }

        public bool ShowFilteringPanel { get; set; }

        public string Q { get; set; }
        public DateTime? CreatedFrom { get; set; }
        public bool TogglePriceEnabled { get; set; }
        ...
        public class ManufacturerFilterModel : BaseNopModel
        {
        ...
        public class CategoryFilterModel : BaseNopModel
        {
            public bool Enabled { get; set; }
        ...
        public class ManufacturerFilterItem : BaseNopModel
        {
        ...
        public class CategoryFilterItem : BaseNopModel
        {
            public string Name { get; set; }
            public int Id { get; set; }
            public bool Selected { get; set; }
        ...
        public class AttributeFilterModel : BaseNopModel
        {
            #region Const
            ...
            public AttributeFilterModel()
            {
                ...
                AlreadyFilteredItems = new List<AttributeFilterItem>();
            }
            ...
            public IList<AttributeFilterItem> AlreadyFilteredItems { get; set; }

            #endregion
        }

        public class AttributeFilterItem : BaseNopModel
        {
        ...
        public class PriceRangeSliderModel
        {
            public PriceRangeSliderFilterItem Item { get; set; }
            public PriceRangeSliderFilterItem ItemValueSet { get; set; }
            public PriceRangeSliderFilterItem FilteredItem { get; set; }
            public PriceRangeSliderModel()
            {
                Item = new PriceRangeSliderFilterItem();
                ItemValueSet = new PriceRangeSliderFilterItem();
                FilteredItem = new PriceRangeSliderFilterItem();
            }
        }
        
        public class PriceRangeSliderFilterItem 
        {

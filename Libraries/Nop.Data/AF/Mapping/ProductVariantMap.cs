    ...
    public partial class ProductVariantMap : EntityTypeConfiguration<ProductVariant>
    {
        public ProductVariantMap()
        {
            ...
            this.HasOptional(c => c.Currency)
                .WithMany(cur => cur.ProductVariants)
                .HasForeignKey(c => c.CurrencyId).WillCascadeOnDelete(false);

            this.Property(pv => pv.CurrencyPrice).HasPrecision(18, 4);
            this.Property(pv => pv.CurrencyOldPrice).HasPrecision(18, 4);
            this.Property(pv => pv.CurrencyProductCost).HasPrecision(18, 4);

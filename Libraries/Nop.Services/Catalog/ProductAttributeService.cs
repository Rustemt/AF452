...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        public virtual ProductVariantAttributeCombination GetProductVariantAttributeCombinationByBarcode(string Barcode)
        {
            ...
            var query = from pvac in _productVariantAttributeCombinationRepository.Table
                        orderby pvac.Id
                        where pvac.ProductVariantBarcode == Barcode
                        select pvac;
            var productVariantAttributeCombinations = query.FirstOrDefault();
            return productVariantAttributeCombinations;
        }

...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        public CustomerService(ICacheManager cacheManager,
            ...
            IRepository<CustomerProductVariantQuote> customerProductVariantQuoteRepository,
            IEventPublisher eventPublisher)
        {
            ...
            this._customerProductVariantQuoteRepository = customerProductVariantQuoteRepository;
        ...
        {
            var query = _customerRepository.Table.Where(x => x.Email != null);

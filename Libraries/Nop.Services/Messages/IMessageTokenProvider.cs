...
namespace Nop.Services.Messages
{
    public partial interface IMessageTokenProvider
    {
        ...
        void AddOrderTokens(IList<Token> tokens, Order order, int languageId,bool ShowCheckOutAttribute);

        void AddOrderTokensForSalesAgreementsPdf(IList<Token> tokens, Order order, int languageId);
        ...
        void AddCustomerTokensForSalesAgreementsPdf(IList<Token> tokens, Customer customer);

        void AddNewsLetterSubscriptionTokens(IList<Token> tokens, NewsLetterSubscription subscription);

        void AddCampaignNewsLetterSubscriptionTokens(IList<Token> tokens, NewsLetterSubscription subscription);

        void AddCampaignConvokeNewsLetterSubscriptionTokens(IList<Token> tokens, NewsLetterSubscription subscription);
        ...
        void AddSalesAgreementTokens(IList<Token> tokens, SalesAgreement SalesAgreementDetails);
    }
}

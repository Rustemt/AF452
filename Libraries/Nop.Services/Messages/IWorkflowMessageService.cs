...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        //TODO:Af-delete
        int SendCustomerMigrationPasswordRecoveryMessage(Customer customer, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendOrderPlacedStoreOwnerNotification(Order order, int languageId, bool ShowCheckOutAttribute);
        ...
        int SendCampaignRegisterActivationMessage(NewsLetterSubscription subscription,
            int languageId);

        int SendCampaignConvoke(NewsLetterSubscription subscription,
            int languageId);

...
namespace Nop.Services.Messages
{
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        private IList<Token> GenerateTokens(NewsLetterSubscription subscription, string MessageTemplateName)
        {
            if (MessageTemplateName == "Campaign.Register.ActivationMessage")
            {
                var tokens = new List<Token>();

                _messageTokenProvider.AddStoreTokens(tokens);
                _messageTokenProvider.AddCampaignNewsLetterSubscriptionTokens(tokens, subscription);
            ...
            else
            {
                ...
                _messageTokenProvider.AddStoreTokens(tokens);
                _messageTokenProvider.AddCampaignConvokeNewsLetterSubscriptionTokens(tokens, subscription);
        ...
        public virtual int SendCustomerMigrationPasswordRecoveryMessage(Customer customer, int languageId)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
            ...
            var messageTemplate = GetLocalizedActiveMessageTemplate("Customer.MigrationPasswordRecovery", languageId);
            if (messageTemplate == null)
                return 0;
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public virtual int SendOrderPlacedStoreOwnerNotification(Order order, int languageId,bool ShowCheckOutAttribute)
        {
            if (order == null)
            ...
            var orderTokens = GenerateTokens(order, languageId, ShowCheckOutAttribute);
        ...
        public virtual int SendOrderPlacedCustomerNotification(Order order, int languageId)
        {
            ...
            messageTemplate = order.PaymentMethodSystemName == "Payments.PurchaseOrder"
                                  ? GetLocalizedActiveMessageTemplate("OrderPlaced.WithAccountInfoCustomerNotification", languageId)
                                  : GetLocalizedActiveMessageTemplate("OrderPlaced.CustomerNotification", languageId);
            if (messageTemplate == null)
                return 0;
            var orderTokens = GenerateTokens(order, languageId,false);
            var emailAccount = GetEmailAccountOfMessageTemplate(messageTemplate, languageId);
        ...
        public virtual int SendCampaignRegisterActivationMessage(NewsLetterSubscription subscription,
            int languageId)
        {
            if (subscription == null)
                throw new ArgumentNullException("subscription");
            ...
            var messageTemplate = GetLocalizedActiveMessageTemplate("Campaign.Register.ActivationMessage", languageId);
            if (messageTemplate == null)
                return 0;

            var orderTokens = GenerateTokens(subscription, "Campaign.Register.ActivationMessage");
        ...
        public virtual int SendCampaignConvoke(NewsLetterSubscription subscription,
            int languageId)
        {
            if (subscription == null)
                throw new ArgumentNullException("subscription");
            ...
            var messageTemplate = GetLocalizedActiveMessageTemplate("Campaing.Register.Convoke", languageId);
            if (messageTemplate == null)
                return 0;

            var orderTokens = GenerateTokens(subscription, "Campaing.Register.Convoke");
